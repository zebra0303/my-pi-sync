---
name: nx-generate
description: Generate code using Nx generators in pi. INVOKE IMMEDIATELY when user mentions scaffolding, setup, structure, creating apps/libs, or setting up project structure. Trigger words - scaffold, setup, create a ... app, create a ... lib, project structure, generate, add a new project. Prefer local workspace generators and always inspect generator behavior before applying.
---
...
Use the Nx CLI to discover available generators. In pi, always prefix Nx with the detected package manager (`pnpm nx`, `yarn nx`, `npm exec nx --`, etc.). Examples use `pnpm nx`:
